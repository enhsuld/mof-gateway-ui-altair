angular
    .module('altairApp')
    	.controller("egnoSettingsCtrl",['$rootScope','$scope','orgs','mainService','$state','sweet','$cookies',
	        function ($rootScope,$scope,orgs,mainService,$state,sweet,$cookies) {
                ...
                $scope.domain="com.macro.dev.models.SettingsEgNo.";
				...
				$scope.pmenuGrid = {
					dataSource: {
						...
						transport: {
							read:  {
								url: "/api/core/list/SettingsEgNo?access_token="+$cookies.get('access_token'),
					...
					columns: [
						...
						{ field:"egno", title: "Нэр /Mn/", width: 200 },
						{ field: "autoinc", title:"URL"}
					],
					dataBound: function () {
					var rows = this.items();
					  $(rows).each(function () {
