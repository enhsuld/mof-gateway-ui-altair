angular
    .module('altairApp')
    .controller("fnewexpCtrl",['$scope','$rootScope','orgs','mainService','$state','sweet','$cookies',
        function ($scope,$rootScope,orgs,mainService,$state,sweet,$cookies) {
            ...
            $scope.exp.cAlbCurrency=true;
            $scope.exp.cAwaxCurrency=true;
            $scope.exp.cChangeRate=false;
            $scope.cChangeRate=function () {
                if($scope.exp.cChangeRate==true){
                    $scope.exp.cAlbCurrency=false;
                    $scope.exp.cAwaxCurrency=false;
                }
                if($scope.exp.cChangeRate==false){
                    $scope.exp.cAlbCurrency=true;
                    $scope.exp.cAwaxCurrency=true;
                }
            }
            $scope.exp.bAlbCurrency=true;
            $scope.exp.bAwaxCurrency=true;
            $scope.exp.bChangeRate=false;
            $scope.bChangeRate=function () {
                if($scope.exp.bChangeRate==true){
                    $scope.exp.bAlbCurrency=false;
                    $scope.exp.bAwaxCurrency=false;
                }
                if($scope.exp.bChangeRate==false){
                    $scope.exp.bAlbCurrency=true;
                    $scope.exp.bAwaxCurrency=true;
                }
            }
